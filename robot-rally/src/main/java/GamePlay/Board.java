...
//	    }
	...
	public Board(int cols) {
		dimensions = cols;
		elements = new ArrayList<StorageElement>();
	}
...
//		factory.add(new Obstacle());
	...
	public boolean isEmpty(Coordinates coordinates) {
		return !(elements.stream().anyMatch(o -> o.element.coordinates.equals(coordinates)));
	}

	public void add(Element e) {
		if(!elements.contains(e)) {
			StorageElement s = new StorageElement(counter,e);
			counter++;
			elements.add(s);
		}
	}
	...
	public boolean contains(Element e) {
		return elements.stream().anyMatch(o -> o.element.equals(e));
	}
	...
	public Element getElement(Coordinates c) {
		return (elements.stream().filter(o -> o.element.coordinates.equals(c)).findFirst().orElse(null)).element;
	}
